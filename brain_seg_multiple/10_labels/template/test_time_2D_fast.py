...
check_ing_path = '/code/CZQ/202300/01/check/'           #模型参数文件的存储路径
...
if 1 > 0:
    ...
    #最后修改时间从旧到新
    check_list.reverse() 
    print('Number of Check Files: ',len(check_list))
    
    #model_feature = getattr(models, 'unet_3dd')() 
    #model_feature.cuda()
    #model_feature.load_state_dict(t.load('/userhome/GUOXUTAO/2020_00/TEST/gNET11/checkpoints/0.9918033409118653_4444_134.2940625_0.0001_4_0227_03_57_11.pth'))

    #for index,checkname in enumerate(check_list):
        #print(index,checkname)
    checkname = '0_4444_0_0.0001_10_1103_11:55:19.pth'
    if checkname in check_list:
        print('Selected Check File: ',checkname)
...
#             continue
        ...
        if checkname != 'un' and checkname != '01':
            ...
            if 1 > 0:
                ...
                testpath = '/code/CZQ/202300/000/test_normalized/'
