...
#model.load_state_dict(t.load('/code/CZQ/202300/01/check/pth/0_4444_0_0.0001_10_1031_22:27:28.pth'))
...
for epoch in range(opt.max_epoch):
    ...
    if epoch%4==1:
        ...
        if 1 > 0:
            ...
            prefix = '/code/CZQ/202300/01/check/pth/' + str(acc)+'_4444_'+str(val_loss) + '_'+str(lr)+'_'+str(batch_size)+'_'
            ...
            name1 = time.strftime('/code/CZQ/202300/01/check/plt/' + '%m%d_%H:%M:%S.npy')   
